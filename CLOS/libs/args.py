...
# Add argument
def add_arg(arg_name, optional, arg_alt_value = '', arg_has_alt = False, arg_alt_name = '', arg_missing_text = '', has_config = False, config_name = '', has_value = True, value_type = 'any'):
