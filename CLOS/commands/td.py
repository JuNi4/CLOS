...
if str(x).lower() == str(pdata['fav_color'].lower()):
    print(f'Although I said there where no right or wrong answer, you answered.......     correctly! This is because you set {x.upper()} as your favourite color while setting up CLOS.')
else:
